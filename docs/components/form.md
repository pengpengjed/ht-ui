...
| `collapseTransition`<el-tag>v0.1.15</el-tag> | 是否需要表单变化动画，**在[PlusSearch](/search.html#search-attributes)和[PlusStepsForm ](/components/steps-form.html#stepsform-attributes)组件中效果明显**                                                                    | `boolean`                                                                                | `true`  | 否       |
